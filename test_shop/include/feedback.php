...
<?/*if(IsModuleInstalled("idea")):?>
    <?$APPLICATION->IncludeComponent("bitrix:idea.popup", "", array(
            ...
            "PATH_IDEA_INDEX" => "/test_shop/about/idea/",
            "PATH_IDEA_POST" => "/test_shop/about/idea/#post_id#/",
            "BUTTON_COLOR" => "",
            "POST_BIND_STATUS_DEFAULT" => "#IDEA_BIND_STATUS_DEFAULT#",
            "FORGOT_PASSWORD_URL" => "/test_shop/login/?forgot_password=yes",
            "REGISTER_URL" => "/test_shop/login/?clear_cache=Y",
            "CATOGORIES_CNT" => "4",
