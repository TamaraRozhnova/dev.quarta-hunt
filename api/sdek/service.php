    ...
    class CalculationAction extends BaseAction
    {
        ...
        protected function calculate($shipment)
        {
            ...
            $arData = array(
                ...
                'version' => '1.0',
				'authLogin' => 'XOlAxGCIfVdenTUIIjS4rHfjup5tviyx', // $this->controller->getValue($headers, 'account'),
				'secure' => 'ATttW2E6ACWWyXd75R1L6nL52eKP2UIV', // $this->controller->getValue($headers, 'secure'),
