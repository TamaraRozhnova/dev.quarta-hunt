...
$aTabs = array(
    array(
        "DIV" => "edit",
        "TAB" => Loc::getMessage("INTERLABS_ONECLICK_OPTIONS_TAB_NAME"),
        "TITLE" => Loc::getMessage("INTERLABS_ONECLICK_OPTIONS_TAB_NAME"),
        "OPTIONS" => array(
            Loc::getMessage("INTERLABS_ONECLICK_OPTIONS_TAB_COMMON"),


            array(
                "person_type_id",
                Loc::getMessage("INTERLABS_ONECLICK_OPTIONS_TAB_PERSON_TYPE_ID"),
                "",
                array("selectbox", $arSalePersonType)
            ),
            array(
                "delivery_id",
                Loc::getMessage("INTERLABS_ONECLICK_OPTIONS_TAB_DELIVERY_ID"),
                "",
            ...
            array(
                "pay_system_id",
                Loc::getMessage("INTERLABS_ONECLICK_OPTIONS_TAB_PAY_SYSTEM_ID"),
                "",
                array("selectbox", $arPaySystems)
            ),
            array(
                "location_id",
                Loc::getMessage("INTERLABS_ONECLICK_OPTIONS_TAB_LOCATION_ID"),
                "",
                array("selectbox", $arLocation)
            ),
            array(
                "AGREE_PROCESSING_TEXT",
                Loc::getMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_AGREE_PROCESSING_TEXT"),
                "",
                ['textarea', 5]
            ),
...
?>
    ...
    <form action="<? echo($APPLICATION->GetCurPage()); ?>?mid=<? echo($module_id); ?>&lang=<? echo(LANG); ?>"
        ...
        <tr>
            <td width="40%" nowrap>
                <? echo(Loc::GetMessage("INTERLABS_FEEDBACKFORM_OPTIONS_TAB_AGREE_PROCESSING_FILE")); ?>
            <td width="60%">
        ...
        <input type="submit" name="apply"
               value="<? echo(Loc::GetMessage("INTERLABS_ONECLICK_OPTIONS_INPUT_APPLY")); ?>" class="adm-btn-save"/>
        <input type="submit" name="default"
               value="<? echo(Loc::GetMessage("INTERLABS_ONECLICK_OPTIONS_INPUT_DEFAULT")); ?>"/>
