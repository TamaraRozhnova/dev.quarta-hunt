function interlabsOneClickComponentApp() {
    ...
    $('.interlabs-oneclick__container').each(function(){
         ...
         * Close action
         */
        dialog.find('.js-interlabs-oneclick__dialog__close, .js-interlabs-oneclick__dialog__cancel-button')
            .off('click')
            .on('click', function () {
                dialog.hide();
            });
    ...
    $('.interlabs-one-click-buy').on('click', function () {
        ...
        const dialog = $(`#interlabs-oneclick__container-${productId}`);
         ...
         * Save action
         */
       /* dialog.find('.js-interlabs-oneclick__dialog__send-button')
            .off('click')
            .on('click', function () {
                const btn = $(this);
                ...
                $.ajax({
                    ...
                    //dataType: "json",
                    //url: '/ajax/ajax.interlabs.oneclick.save.php',
                    processData: false,
                    contentType: false,
                    data: formData,
                    success: function (data) {
                        ...
                        if (data.errors) {
                            ...
                            dialog.find('.js-interlabs-oneclick__result').html(data.data.message);
                        }
