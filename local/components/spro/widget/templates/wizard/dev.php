...
if (intval( $_REQUEST["IBLOCK_ID_FIELDS"] ) > 0)
{
	...
	{
		LocalRedirect( $APPLICATION->GetCurPageParam( "success=Y", [ "success", "IBLOCK_ID_FIELDS" ] ) );
	}
	else
	{
		LocalRedirect( $APPLICATION->GetCurPageParam( "error=Y", [ "success", "IBLOCK_ID_FIELDS" ] ) );
	}
}
