<?
$MESS["SOA_BTN_ORDER"] = "Нажимая кнопку «Оформить заказ»,";
$MESS["SOA_BTN_ORDER_AGREE"] = "я даю свое согласие на обработку моих персональных данных, в соответствии с Федеральным законом от 27.07.2006 года №152-ФЗ «О персональных данных», на условиях и для целей, определенных в Согласии на обработку персональных данных";
$MESS["SOA_BTN_OFERTA_AGREE"] = ", а так же подтверждаю своё согласие с офертой";
$MESS["SOA_IN_ORDER"] = "В заказе #QUANTITY_TEXT# на сумму #PRICE_TEXT#";
$MESS["SOA_YES"] = "да";
$MESS["SOA_NO"] = "нет";
...
$MESS["SOA_SUM_IT"] = "Итого к оплате";
...
$MESS["PAYMENT_BLOCK_NAME_DEFAULT"] = "Как вам будет удобнее оплатить заказ?";
$MESS["DELIVERY_BLOCK_NAME_DEFAULT"] = "Где и как вы хотите получить заказ?";
$MESS["BUYER_BLOCK_NAME_DEFAULT"] = "Укажите данные получателя заказа";
...
$MESS["CAN_PAY_LATER"] = "Данный заказ можно будет оплатить только после звонка менеджера";
$MESS["RESTRICTED_MESSAGE"] = "В вашем заказе присутствует товар, требующий лицензию на приобретение. Такой товар можно приобрести только самовывозом из розничного магазина в Санкт-Петербурге.";
$MESS['EMPTY_EMAIL_TEXT'] = 'Вы можете получить скидку на этот заказ. Добавьте email, чтобы активировать программу лояльности.';
