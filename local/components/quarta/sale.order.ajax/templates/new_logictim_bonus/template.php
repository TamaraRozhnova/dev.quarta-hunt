	...
	<form action="<?=$APPLICATION->GetCurPage();?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
            ...
            <div id="bonus_payment_block" class="bx-soa-section">
                <div class="bx-soa-section-title-container">
                    <h2 class="bx-soa-section-title col-sm-9">
                        <span class="bx-soa-section-title-count"></span><?=COption::GetOptionString("logictim.balls", "TEXT_BONUS_FOR_PAYMENT", 'Pay from bonus')?>
                    </h2>
                </div>
                    ...
                    <div class="bonus_comment">
                        ...
                        <div id="bonus_payfield_block">
                            ...
                            <div class="bx-soa-coupon-input">
                                <input type="text" id="LOGICTIM_PAYMENT_BONUS" class="form-control bx-ios-fix" onchange="BX.Sale.OrderAjaxComponent.sendRequest();" value="<?=$arResult["PAY_BONUS"]?>" name="ORDER_PROP_<?=$arResult["ORDER_PROP_PAYMENT_BONUS_ID"]?>">
                            </div>
                        </div>
                    </div>
               </div>
