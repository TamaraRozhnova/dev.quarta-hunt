...
if ($arParams["SHOW_INPUT"] !== "N"): ?>
	<div id="<? echo $CONTAINER_ID ?>" class="bx-searchtitle search-live__wrapper <?= $arResult["VISUAL_PARAMS"]["THEME_CLASS"] ?>">
		<form action="<? echo $arResult["FORM_ACTION"] ?>">
			<input id="<? echo $INPUT_ID ?>" placeholder="<?= $arParams["INPUT_PLACEHOLDER"] ?>" type="text" name="q" value="<?= htmlspecialcharsbx($_REQUEST["q"]) ?>" autocomplete="off" class="form-control border-primary bg-white bx-form-control" />
