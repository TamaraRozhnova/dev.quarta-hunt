		...
		BX.ready(function() {
			...
			for (id in arBonus_<?= $arParams["RAND"] ?>) {
				...
				if (BX('lb_ajax_' + id) && item.VIEW_BONUS > 0) {
					BX.adjust(BX('lb_ajax_' + id), {
						html: `
							<span class="product__bonus-balls">+${item.VIEW_BONUS} <?= COption::GetOptionString("logictim.balls", "TEXT_BONUS_FOR_ITEM", '') ?></span>
							<span class="product__bonus-text"><?= GetMessage("BONUS_INFO") ?></span>
							<span class="product__bonus-ico">
								...
								<div class="product__bonus-ico-tip">
                            	    <div class="product__bonus-ico-tip-title">
                            	        <span><?= GetMessage("BONUS_TIP_TITLE") ?></span>
                            	    </div>
                            	    <div class="product__bonus-ico-tip-text">
                            	        <span><?= GetMessage("BONUS_TIP_TEXT") ?> 
                            	            <a href="/promo/bonusnaya-nakopitelnaya-sistema-/"><?= GetMessage("BONUS_TIP_LINK") ?></a>
                            	        </span>
                            	    </div>
