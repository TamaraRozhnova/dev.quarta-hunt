...
$MESS["AUTH_LOGIN_PHONE"] = "Вход по номеру телефона";
$MESS["AUTH_LOGIN_PHONE_SUBMIT"] = "Получить код из СМС";
$MESS["AUTH_LOGIN_CODE"] = "Введите полученный код";
...
$MESS["AUTH_EMAIL_FORM"] = "Войти с помощью электронной почты";
