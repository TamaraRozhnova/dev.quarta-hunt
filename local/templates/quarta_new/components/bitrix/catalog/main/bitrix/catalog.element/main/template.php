...
<div>
    <section class="product"
         ...
         data-product-basket="<?= $arResult['QUANTITY_IN_BASKET'] ?>"
    >
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                            ...
                            <div class="product__share">
                                <div class="product__share-modal">
                                    <a class="product__share-btn share-network-whatsapp" data-sharer="Whatsapp">
                                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/icons/whatsapp-circle.svg" alt="Whatsapp" />
                                        <span>Whatsapp</span>
                                    </a>
                                    <a class="product__share-btn share-network-vk sharer" data-sharer="vk">
                                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/icons/vk-circle.svg" alt="Вконтакте" />
                                        <span>Вконтакте</span>
                                    </a>
                                    <a class="product__share-btn share-network-telegram sharer" data-sharer="telegram">
                                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/icons/telegram-circle.svg" alt="Telegram" />
                                        <span>Telegram</span>
                                    </a>
                                </div>
                    ...
                    <? if ($arResult['AVAILABLE']) { ?>
                        <div class="price">
                            <span class="price__current"><?= $arResult['PRICES']['PRICE'] ?> ₽</span>
                            <? if ($arResult['PRICES']['OLD_PRICE']) { ?>
                                <span class="price__old"><?= $arResult['PRICES']['OLD_PRICE'] ?> ₽</span>
                            <? } ?>
                            <? if ($arResult['PRICES']['DISCOUNT']) { ?>
                                <span class="price__discount">-<?= $arResult['PRICES']['DISCOUNT'] ?>%</span>
                            <? } ?>
                        </div>
                    <? } ?>
...
<!--                            <a>Посмотреть наличие</a>-->
                    ...
                    <? if (!empty($arResult['OFFERS'])) { ?>
                        <div class="select__wrapper product__trade-offers">
                                    ...
                                    <div class="select__options">
                                        <? foreach ($arResult['OFFERS'] as $offer) { ?>
                                            <div class="select__option"
                                                 ...
                                                 data-basket="<?= $offer['QUANTITY_IN_BASKET'] ?>"
                                            >
                    ...
                    <div class="product__add">
                        ...
                        <? if (!$arResult['PRODUCT']['USE_OFFERS'] && $arResult['QUANTITY_IN_BASKET']) { ?>
                            <div class="product-count">
                                <span class="product-count__add-minus">-</span>
                                <span class="product-count__add-plus">+</span>
                                <input type="number" value="<?= $arResult['QUANTITY_IN_BASKET'] ?>" class="form-control" />
                            </div>
                        <? } ?>
                        ...
                        <? if ($arResult['AVAILABLE'] && !$arResult['PRODUCT']['USE_OFFERS'] && !$arResult['QUANTITY_IN_BASKET']) { ?>
                            <button class="product-basket btn btn-primary px-5">
                                В корзину
                            </button>
                        <? } ?>

                        <button class="product-fav btn bg-white mx-1 <?= $arResult['IN_FAVORITES'] ? 'text-secondary border-secondary in-fav' : '' ?>">
                            <svg class="product-fav__active" style="display: <?= $arResult['IN_FAVORITES'] ? 'inline' : 'none' ?>" width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="product-fav__default" style="display: <?= $arResult['IN_FAVORITES'] ? 'none' : 'inline' ?>" width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span><?= $arResult['IN_FAVORITES'] ? 'В избранном' : 'В избранное' ?></span>
                        </button>
                        <button class="product-compare btn bg-white mx-1 <?= $arResult['IN_COMPARE'] ? 'text-secondary border-secondary in-compare' : '' ?>">
                            <svg class="product-compare__active" style="display: <?= $arResult['IN_COMPARE'] ? 'inline' : 'none' ?>" width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="product-compare__default" style="display: <?= $arResult['IN_COMPARE'] ? 'none' : 'inline' ?>" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
