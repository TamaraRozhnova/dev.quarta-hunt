...
// Главный слайдер
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 14, 'SECTION_ID' => $arResult['PROPERTIES']['MAIN_SLIDER']['VALUE']]);
...
// Второй слайдер
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 14, 'SECTION_ID' => $arResult['PROPERTIES']['SLIDER_2']['VALUE']]);
...
// Третий слайдер
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 14, 'SECTION_ID' => $arResult['PROPERTIES']['SLIDER_3']['VALUE']]);
...
// Четвертый слайдер
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 14, 'SECTION_ID' => $arResult['PROPERTIES']['SLIDER_4']['VALUE']]);
...
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 16, 'ID' => $arResult['PROPERTIES']['REVIEW_PRODUCTS']['VALUE']], false, false, 
...
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 11, 'PROPERTY_PRODUCT_ID' => $arResult['PROPERTIES']['REVIEW_PRODUCTS']['VALUE']], false, false,
...
// Каталог
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 16, 'ID' => $arResult['PROPERTIES']['CATALOG_PRODUCTS']['VALUE']], false, false, 
	['ID', 'NAME', 'CODE', 'CATALOG_PRICE_1', 'CATALOG_PRICE_ID_1', 'CATALOG_CURRENCY_1', 'CATALOG_GROUP_NAME_1', 
		'PROPERTY_CML2_ARTICLE']);
...
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 11, 'PROPERTY_PRODUCT_ID' => $arResult['PROPERTIES']['CATALOG_PRODUCTS']['VALUE']], false, false,
	['ID', 'PROPERTY_PRODUCT_ID', 'PROPERTY_RATING']);
...
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 16, 'ID' => $arResult['PROPERTIES']['ASSORT_PRODUCTS_1']['VALUE']], false, false, 
	['ID', 'NAME', 'CODE', 'CATALOG_PRICE_1', 'CATALOG_PRICE_ID_1', 'CATALOG_CURRENCY_1', 'CATALOG_GROUP_NAME_1', 
		'PROPERTY_CML2_ARTICLE']);
...
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 11, 'PROPERTY_PRODUCT_ID' => $arResult['PROPERTIES']['ASSORT_PRODUCTS_1']['VALUE']], false, false,
	['ID', 'PROPERTY_PRODUCT_ID', 'PROPERTY_RATING']);
...
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 16, 'ID' => $arResult['PROPERTIES']['ASSORT_PRODUCTS_2']['VALUE']], false, false, 
	['ID', 'NAME', 'CODE', 'CATALOG_PRICE_1', 'CATALOG_PRICE_ID_1', 'CATALOG_CURRENCY_1', 'CATALOG_GROUP_NAME_1', 
		'PROPERTY_CML2_ARTICLE']);
...
$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 11, 'PROPERTY_PRODUCT_ID' => $arResult['PROPERTIES']['ASSORT_PRODUCTS_2']['VALUE']], false, false,
	['ID', 'PROPERTY_PRODUCT_ID', 'PROPERTY_RATING']);
