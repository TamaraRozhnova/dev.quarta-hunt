...
<div class="holosun">
                ...
                <div class="col-12 col-md-6 mb-4 mb-md-0">
                    <a href="<?= $arResult['PROPERTIES']['REVIEW_LINK']['VALUE'] ?>"
                       class="promo-card promo-card--background-image promo-card--light promo-card--large promo-card--shadow">
                        ...
                        <span class="mb-4"
                              style="z-index: 1"><?= $arResult['PROPERTIES']['REVIEW_DATE']['VALUE'] ?></span>
            ...
            <div class="vertically-divided__content">
                ...
                <div class="container pb-0">
                    <div size="large" class="video-player">
                        ...
                        >
                            <source src="<?= $arResult['PROPERTIES']['VIDEO_REVIEW_LINK']['VALUE'] ?>"
                                    type="video/mp4"/>
                        </video>
    ...
    <!--    slider 3-->
    <?php if (is_array($arResult['PROPERTIES']['SLIDER_3']['ITEMS']) && count($arResult['PROPERTIES']['SLIDER_3']['ITEMS']) > 0): ?>
        <div class="holosun__wide-slider">
            <div class="wide-promotion">
                <div
                        class="wide-promotion__image"
                            ...
                            <?php foreach ($arResult['PROPERTIES']['SLIDER_4']['ITEMS'] as $arSlide): ?>
                                <div class="swiper-slide swiper-slide-active">
                                    <div class="row slider-card holosun__ruler">
                                        <div class="col-6">
                                            <figure>
                                                <img src="<?= $arSlide['DETAIL_PICTURE']['SRC'] ?>" alt="Holosun"
                                                     class="holosun__contain-img"/>
                                            </figure>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <a href="<?= $arSlide['PROPERTIES']['LINK']['VALUE'] ?>"
                                               class="btn btn-primary mt-4">Перейти в каталог</a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
            ...
            <div class="row py-lg-5 holosun__for">
                ...
                <div class="col-6">
                    <div class="cabinet-section">
                        <div v-if="$slots.header" class="cabinet-section__header">
                            <h3 class="my-3">Для <a
                                        href="<?= $arResult['PROPERTIES']['COND_BLOCK_LINK']['VALUE'][0] ?>"><?= stristr($arResult['PROPERTIES']['COND_BLOCK_TITLE']['VALUE'][0], ' ') ?></a>
                            </h3>
                        </div>
                        ...
                        <div class="cabinet-section__content">
                            ...
                            <a href="<?= $arResult['PROPERTIES']['COND_BLOCK_LINK']['VALUE'][0] ?>"
                               class="btn btn-primary py-3 px-5 mt-2 mb-3">
                                Подробнее
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-6">
                    ...
                    <div class="cabinet-section">
                        <div v-if="$slots.header" class="cabinet-section__header">
                            <h3 class="my-3">Для <a
                                        href="<?= $arResult['PROPERTIES']['COND_BLOCK_LINK']['VALUE'][1] ?>"><?= stristr($arResult['PROPERTIES']['COND_BLOCK_TITLE']['VALUE'][1], ' ') ?></a>
                            </h3>
                        </div>
                        ...
                        <div class="cabinet-section__content">
                            ...
                            <a href="<?= $arResult['PROPERTIES']['COND_BLOCK_LINK']['VALUE'][1] ?>"
                               class="btn btn-primary py-3 px-5 mt-2 mb-3">
                                Подробнее
                            </a>
                        </div>
