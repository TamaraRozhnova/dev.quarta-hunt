...
<script id="basket-item-template" type="text/html">
	<div class="row basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
		id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}">
		{{#SHOW_RESTORE}}
			<div class=" col-12 basket-items-list-item-notification" colspan="<?=$restoreColSpan?>">
		...
		{{/SHOW_RESTORE}}
		{{^SHOW_RESTORE}}
			<div class="col-3 col-md-2 basket-items-list-item-descriptions">
            ...
            <div class="col-9 col-md-10">
                <div class="row">
                    <div class="col-12 order-1 mb-2 order-sm-0 mb-lg-0 col-lg-4 basket-item-block-info">
                        <?
                        if (isset($mobileColumns['DELETE']))
                        {
                            ?>
                            <span class="basket-item-actions-remove d-none" data-entity="basket-item-delete"></span>
                            <?
                        }
                        ?>
                        <div class="basket-item-info__article-container">
                            <span class="basket-item-info__article-title">{{ARTICLE_TITLE}}</span>
                            <span class="basket-item-info__article-text">{{ARTICLE_TEXT}}</span>
                        </div>
                    ...
                    ?>
                    <div class="col-6 order-3 order-sm-0 col-lg-3 basket-items-list-item-amount">
