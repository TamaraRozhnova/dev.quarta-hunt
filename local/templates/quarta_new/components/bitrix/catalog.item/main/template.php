...
>
    <div class="product-card__image">
        ...
        <div class="product-card__image-actions">
            <svg class="product-card__compare product-card__compare--active text-secondary" style="display: <?= $item['IN_COMPARE'] ? 'inline' : 'none' ?>" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg class="product-card__compare product-card__compare--default" style="display: <?= $item['IN_COMPARE'] ? 'none' : 'inline' ?>" width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg class="product-card__fav product-card__fav--default" style="display: <?= $item['IN_FAVORITES'] ? 'none' : 'inline' ?>" width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
