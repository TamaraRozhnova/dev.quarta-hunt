        ...
        <div class="container">
            ...
            <div class="row header__main-row">
                ...
                <div class="header__lists-section col">
                    <a href="/compare" class="btn btn-link px-2 mx-2">
                        <div class="position-relative px-1">
                            ...
                            <span class="position-absolute top-0 start-100 translate-middle badge bg-secondary">1</span>
                        </div>
                    </a>

                    <a href="/favourites" class="btn btn-link px-2 mx-2">
                    ...
                    <a href="/cart" class="btn btn-link px-2 mx-2">
                        <div class="position-relative px-1 text-primary">
        ...
        <div class="header__bottom">
            ...
            <a class="header__bottom-item" href="/compare">
                <div class="header__bottom-icon">
                    ...
                    <div class="header__bottom-bage">1</div>
                </div>
                <span>Сравнить</span>
            </a>
            ...
            <a class="header__bottom-item" href="/favourites">
                <div class="header__bottom-icon">
