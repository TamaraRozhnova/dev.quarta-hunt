...
<head>
    ...
    <meta property="og:image"
          content="<?= $APPLICATION->ShowProperty("og:image", SITE_SERVER_PROTOCOL . SITE_SERVER_NAME . "/upload/logo_og.png") ?>">
            ...
            <a class="header__bottom-item" href="/cart">
                <div class="header__bottom-icon">
                    ...
                    <div class="header__bottom-badge basket-badge"
                         style="display: <?= $basketItemsCount > 0 ? 'flex' : 'none' ?>">
                        <?= $basketItemsCount ?>
                    </div>
                </div>
                <span>Корзина</span>
            ...
            <a class="header__bottom-item" href="/favorites">
                <div class="header__bottom-icon">
                    ...
                    <div class="header__bottom-badge favorites-badge"
                         style="display: <?= $favoritesCount > 0 ? 'flex' : 'none' ?>">
                        <?= $favoritesCount ?>
                    </div>
                </div>
                <span>Избранное</span>
