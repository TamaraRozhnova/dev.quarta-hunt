...
$MESS["REGION_BLOCK_NAME_DEFAULT"] = "1. Где и как вы хотите получить заказ?";
$MESS["PAYMENT_BLOCK_NAME_DEFAULT"] = "2. Как вам будет удобнее оплатить заказ?";
$MESS["DELIVERY_BLOCK_NAME_DEFAULT"] = "Доставка";
$MESS["BUYER_BLOCK_NAME_DEFAULT"] = "4. Укажите данные получателя заказа";
...
$MESS["REGION_REFERENCE_DEFAULT"] = "Введите свой город или выберите из предложеных";
...
$MESS['PROMO_BLOCK_TITLE'] = '3. Промокод';
$MESS['ACTIVATE_COUPON_BTN'] = 'Применить';
$MESS['BACK_TO_CART'] = 'Вернуться в корзину';
$MESS['TOTAL_BASKET_COUNT'] = 'Количество';
$MESS['PERSONAL_REQUEST'] = 'Нажимая кнопку «Оформить заказ», я даю своё согласие на обработку моих персональных данных, в соответствии с Федеральным законом от 27.07.2006 года № 152-ФЗ «О персональных данных», на условиях и для целей, определённых <a href="#">в политике конфиденциальности</a>';
$MESS['NEED_CALL_TITLE'] = 'Нужен звонок менеджера';
$MESS['CONFIRM_ORDER_TITLE'] = 'Заказ оформлен';
$MESS['STATUS_ORDER_TEXT'] = 'Статус заказа можно узнать в личном кабинете или по телефону 8 (800) 000 00-00 ';
$MESS['CATALOG_TEXT'] = 'Продолжить покупки';
$MESS['PERSONAL_TEXT'] = 'в Личный кабинет';