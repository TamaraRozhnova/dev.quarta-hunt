...
<div class="product-item">
	<? if ($itemHasDetailUrl): ?>
		...
		<? else: ?>
			...
			<span class="product-item-image-original <?= $item['PROPERTIES']['FULL_PREVIEW']['VALUE'] ? 'full' : '' ?>" id="<?= $itemIds['PICT'] ?>"
	...
	<? endif; ?>
	<button data-product-id="<?= $item['ID'] ?>" type="button" class="button product__favorites"><?= buildSVG('product-favorite', SITE_TEMPLATE_PATH . ICON_PATH) ?></button>
	<?
	if (!empty($arParams['PRODUCT_BLOCKS_ORDER'])) {
		foreach ($arParams['PRODUCT_BLOCKS_ORDER'] as $blockName) {
			switch ($blockName) {
				...
				case 'buttons':
					?>
					<div style="display: none" class="product-item-info-container product-item-hidden" data-entity="buttons-block">
						<?
						if (!$haveOffers) {
