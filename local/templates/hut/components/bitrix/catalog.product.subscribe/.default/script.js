        ...
        if (result.success) {
          ...
          this.elemPopupWin.setButtons([
            new subscribeButton({
              ...
              className: "button button-secondary close",
              events: {
            ...
            new subscribeButton({
              text: BX.message("CPST_SUBSCRIBE_BUTTON_NAME2"),
              className: "button button-primary send",
              events: {
                click: BX.delegate(function () {
              ...
              children: [
                BX.create("input", {
                  props: {
                    ...
                    type: "text",
                    name: "contact[" + k + "][user]",
                    placeholder: BX.message(
                      "CPST_SUBSCRIBE_LABLE_CONTACT_INPUT_PLACEHOLDER"
                    ),
                  },
                  attrs: { "data-id": k },
                }),
