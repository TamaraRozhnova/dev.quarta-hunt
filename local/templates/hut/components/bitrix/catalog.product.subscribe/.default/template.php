...
if ($showSubscribe): ?>
	...
	<script type="text/javascript">
		BX.message({
			...
			CPST_SUBSCRIBE_BUTTON_NAME2: '<?= GetMessageJS('CPST_SUBSCRIBE_BUTTON_NAME2'); ?>',
			CPST_SUBSCRIBE_LABLE_CONTACT_INPUT_PLACEHOLDER: '<?= GetMessageJS('CPST_SUBSCRIBE_LABLE_CONTACT_INPUT_PLACEHOLDER'); ?>',
			CPST_SUBSCRIBE_SUCCESS: '<?= GetMessageJS('CPST_SUBSCRIBE_SUCCESS'); ?>'
		});
