<?
$MESS["SPOL_TPL_EMPTY_ORDER_LIST"] = "У вас еще нет заказов";
$MESS["SPOL_TPL_EMPTY_ORDER_LIST_DESC"] = "В этом разделе будет появляться информация о ваших заказах";
$MESS["SPOL_TPL_NO_ORDER"] = "Заказ не найден";
$MESS["SPOL_TPL_NO_ORDER_DESC"] = "Не нашли заказа с таким номером";
...
$MESS["SPOL_TPL_LINK_TO_CATALOG"] = "За покупками";
...
$MESS["SPOL_TPL_DATE"] = "Дата";
$MESS["SPOL_TPL_PAYMENT"] = "Оплата";
$MESS["SPOL_TPL_BILL"] = "Счет";
$MESS["SPOL_TPL_SEARCH"] = "Поиск по номеру";
