...
<div class="main-prod__section container-no-padding" data-entity="<?= $containerName ?>">
	<div class="main-prod__top">
		<div class="main-prod__title"><?= $arResult['NAME'] ?></div>
		<a class="main-section__link" href="<?= $arResult['SECTION_PAGE_URL'] ?>">Все товары</a>
	</div>
	<div class="main-prod__sections">
		<a class="main-prod__section" href="<?= $arResult['SECTION_PAGE_URL'] ?>">Все</a>
		<? foreach ($arResult['INNER_SECTIONS'] as $section) { ?>
			<a class="main-prod__section" href="<?= $section['SECTION_PAGE_URL'] ?>"><?= $section['NAME'] ?></a>
		<? } ?>
	</div>
	<?
