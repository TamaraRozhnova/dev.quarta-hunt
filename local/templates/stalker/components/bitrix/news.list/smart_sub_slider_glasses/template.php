...
<?
$arSelect = Array("ID", "IBLOCK_ID", "CODE", "NAME", "PROPERTY_SUBTITLE","DETAIL_PICTURE","PROPERTY_LINK","DETAIL_TEXT");
...
?>
                    <div class="swiper-slide section__slide">
                      ...
                      <div class="section__slide-content">
						  <div class="section__slide-title"> <?=$arFields['PROPERTY_SUBTITLE_VALUE'];?> <div class="section__slide-title__name"><?=$arFields['NAME'];?></div>
                        </div>
