								...
								<div class="smart-filter-parameters-box-container">
									<div class="smart-filter-input-group-number">
										<div class="d-flex justify-content-between-">
											<div class="form-group" style="width: calc(50% - 35px);margin-right: 14px">
											...
											<div class="form-group" style="width: calc(50% - 35px);">
												<div class="smart-filter-input-container">
													<input
						...
						<div class="smart-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								<div class="smart-filter-input-group-checkbox-list">
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											<div class="form-group form-check mb-1 <?=$ar["CHECKED"]? 'checked': ''?>">
												<input
													type="checkbox"
			...
			<div class="row">
				<div class="col smart-filter-button-box">
					<div class="smart-filter-block">
						<div class="smart-filter-parameters-box-container d-flex justify-content-between">
							<input
								class="ui-button ui-button--dark"
								type="submit"
								id="set_filter"
								name="set_filter"
							...
							/>
							<input
								class="ui-button ui-button--transparent"
								type="submit"
								id="del_filter"
								name="del_filter"
