    ...
    <div class="card-right">
		<div class="card__description">
			...
			<div class="card__actions">
				...
				<button type="button" class="ui-button card__basket" data-add-basket="<?=$arResult['ID']?>">
					В корзину
				</button>
				<?php /*
...
<div class="card-info custom-text">
	...
	<div class="card-info__block card-info__description" id="description">
		<?=$arResult['DETAIL_TEXT']?>
	</div>

	<?php if (!empty($arResult["PROPERTIES_CHANK"])): ?>
		<div class="card-info__block card-info__characteristic" id="characteristic">
            <div class="title">Характеристики</div>

            <div class="card-info__characteristic--two">
            <? foreach ($arResult["PROPERTIES_CHANK"] AS $arChank) { ?>
            <div class="two_blocks">

				<?php foreach ($arChank as $prop) { ?>
	...
	<div class="card-info__block card-info__review review" id="review">
		<h2>Отзывы</h2>
		...
		<?if ($arResult['REVIEWS']) { ?>
			<div class="swiper">
				...
				<div class="swiper-wrapper">
									...
									<div class="review-item__body">
										<div class="review-item__img">
											...
											<?php if (isset($arReview['PREVIEW_PICTURE'])): ?>
												<? $img = CFile::ResizeImageGet($arReview['PREVIEW_PICTURE'], array('width' => 114, 'height' => 81), BX_RESIZE_IMAGE_EXACT);  ?>
					...
					<?php endforeach; ?>
                    <div class="swiper-slide">
                        <button class="ui-button review-button-add" data-modal-open="reviews">
                            Оставить отзыв
                        </button>
                    </div>
				</div>
