				...
				while ($ob = $res->GetNextElement())
				{
					...
					<div class="swiper-slide hero__slide">
						...
						<div class="hero__slide-content">
							<div class="hero__slide-title"><?=$arFields['NAME'];?></div>
						<div class="hero__slide-subtitle"><?=$arFields['PREVIEW_TEXT'];?></div>
							...
							<a href="<?=$arFields['PROPERTY_LINK_VALUE'];?>" class="ui-button ui-button--red" style="min-width: 217px"> ПОДРОБНЕЕ </a>
						</div>
